...
public class StudentDao {
	...
	// 회원 삭제
	public int deleteStu(Connection conn, Student student) {

		StringBuffer query = new StringBuffer();
		query.append("DELETE				");
		query.append("		students		");
		query.append("WHERE 1=1				");
		query.append("	AND stu_id in ?");		//하나만 삭제해서 ? 하나
		...
		// 회원 전체 삭제(where절 안갖고오면됨. 그럼 전체 삭제됨)
	...
	// 회원 수정
	public int updateStu(Connection conn, Student student) {
		StringBuffer query = new StringBuffer();
